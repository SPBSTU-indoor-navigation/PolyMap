...
internal enum Asset {
  ...
  internal enum Annotation {
    internal enum Amenity {
      internal static let academicCouncil = ImageAsset(name: "academic.council")
      ...
      internal static let stadiumFootball = ImageAsset(name: "stadium.football")
      internal static let stadium = ImageAsset(name: "stadium")
      internal static let stadiumVolleyball = ImageAsset(name: "stadium.volleyball")
    ...
    internal enum Colors {
      ...
      internal enum Units {
        ...
        internal static let laboratoryAnnotationLabel = ColorAsset(name: "laboratory-annotation-label")
        internal static let laboratoryAnnotation = ColorAsset(name: "laboratory-annotation")
        internal static let libraryAnnotation = ColorAsset(name: "library-annotation")
        internal static let museumAnnotation = ColorAsset(name: "museum-annotation")
        internal static let readingRoomAnnotation = ColorAsset(name: "reading.room-annotation")
        ...
        internal static let ticketAnnotation = ColorAsset(name: "ticket-annotation")
